...
namespace QCEDL.Client
{
    public class PartStream : Stream
    {
        ...
        public override long Length => (long)((lastSector - firstSector + 1) * sectorBasedReader.GetSectorSize());
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            byte[] blocks = sectorBasedReader.ReadSectors(this.firstSector + (ulong)firstSector, this.firstSector + (ulong)lastSector);
